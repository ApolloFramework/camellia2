//
//  OldroydBFormulationUWReduced.h
//  Camellia
//
...
#ifndef Camellia_OldroydBFormulationUWReduced_h
#define Camellia_OldroydBFormulationUWReduced_h
...
namespace Camellia
{
class OldroydBFormulationUWReduced
{
  BFPtr _oldroydBBF;
...
public:
  OldroydBFormulationUWReduced(MeshTopologyPtr meshTopo, Teuchos::ParameterList &parameters);
//  OldroydBFormulationUWReduced(int spaceDim, bool useConformingTraces, double mu = 1.0,
//                       bool transient = false, double dt = 1.0);
  ...
  // ! implementation, assumes that the constructor arguments provided to OldroydBFormulationUWReduced were the same
  // ! on the OldroydBFormulationUWReduced on which save() was invoked as they were for this OldroydBFormulationUWReduced.
  ...
  // static OldroydBFormulationUWReduced steadyFormulation(int spaceDim, double mu, bool useConformingTraces);
