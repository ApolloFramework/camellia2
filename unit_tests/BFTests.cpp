...
namespace
{
  ...
  TEUCHOS_UNIT_TEST( BF, FactoredCholeskySolve_SimpleSquareMatrices2 )
  {
    int testCount = 2, trialCount = 2;
    ...
    stiffnessExpected[0] = 4.75;     stiffnessExpected[2] = 3.00;
    stiffnessExpected[1] = 3.00;     stiffnessExpected[3] = 2.00;
